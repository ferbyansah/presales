<div class="row">
	<div class="col-md-4">
		<a href="app/tambah_penjualan" class="btn btn-primary">Tambah Data</a>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="app/hapus_penjualan_cust/<?php echo $row->kode_transaksi ?>" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm('Are You Sure ?')">hapus</a>
						<!-- <a href="app/cetak_penjualan/<?php echo $row->kode_transaksi ?>" target="_blank" class="btn btn-success btn-sm">cetak quatation</a> -->
					</td>
				</tr>
				<?php } ?>
			</tbody>
