<div class="row" style="margin-bottom: 10px">
       ...
       <!--  <th>Kode Supplier</th> -->
        ...
        <th>Action</th>
            ...
            <!-- <td><?php echo $barang->kode_supplier ?></td> -->
            ...
            <td style="text-align:center" width="200px">
                <?php 
                echo anchor(site_url('barang_sup/update/'.$barang->id_barang),'Update'); 
                echo ' | '; 
                echo anchor(site_url('barang_sup/delete/'.$barang->id_barang),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                ?>
            </td>
        </tr>
                <?php
