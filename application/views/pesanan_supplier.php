			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="app/cetak_penjualan_sup/<?php echo $row->kode_transaksi ?>" target="_blank" class="btn btn-success btn-sm">Cetak</a>
						<a href="app/ubah/<?php echo $row->kode_transaksi ?>" target="_blank" class="btn btn-success btn-sm">Update</a>
						<?php 
