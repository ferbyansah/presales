...
class Barang_sup extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Barang_model_sup');
    ...
    public function index()
    {
        ...
        $config['total_rows'] = $this->Barang_model_sup->total_rows($q);
        $barang = $this->Barang_model_sup->get_limit_data($config['per_page'], $start, $q);
    ...
    {
        $row = $this->Barang_model_sup->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'harga_beli' => $row->harga_beli,
            ...
            $this->load->view('barang_sup/barang_read', $data);
        } else {
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('barang_sup/create_action'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('barang_sup/update_action'),
		'id_barang' => set_value('id_barang', $row->id_barang),
		'kode_barang' => set_value('kode_barang', $row->kode_barang),
		'nama_barang' => set_value('nama_barang', $row->nama_barang),
		'harga' => set_value('harga', $row->harga),
        'harga_beli' => set_value('stok', $row->harga_beli),
    ...
    public function update_action() 
    {
        ...
        'kode_supplier' => $this->input->post('kode_supplier',TRUE),
            ...
            $this->Barang_model_sup->update($this->input->post('id_barang', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Barang_model_sup->delete($id);
